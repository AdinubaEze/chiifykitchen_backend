...
class WelcomeController{
  public function welcome(){
     return response()->json([
        ...
        "developer"=>[
         "fullname"=>"Emmanuel Eze Adinuba", "email"=>"mradinuba@gmail.com", 
         "youtube"=>"https://www.youtube.com/@mradinuba",
         "instagram"=>"https://instagram.com/@mradinuba",
         "X"=>"https://x.com/@mradinuba"
         ]
     ]);
  }
}